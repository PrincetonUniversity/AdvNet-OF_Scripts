...
class LearningSwitch (object):
  ...
  def __init__ (self, connection, transparent):
    ...
    for k in xrange(1,401):#the default number of rules to install
       #insert first
       msg = of.ofp_flow_mod()
    ...
    for k in xrange(1,401):#the number of rules to install
       #insert first
       msg = of.ofp_flow_mod()
       #msg.match = of.ofp_match.from_packet(packet, event.port)
       #msg.priority = 20000 + randrange(1000)
